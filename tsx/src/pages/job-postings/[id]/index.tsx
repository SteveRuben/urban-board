// frontend/pages/job-postings/[id]/index.tsx
...
export default function JobPostingDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchJobPosting = async () => {
      try {
        setLoading(true);
        const data = await jobPostingService.getJobPosting(id as string);
        setJobPosting(data);
        setError(null);
      } catch (err) {
  ...
  try {
    ...
    const updatedJob = await jobPostingService.publishJobPosting(jobPosting.id);
  ...
  try {
    setActionLoading(true);
    const updatedJob = await jobPostingService.closeJobPosting(jobPosting.id);
    setJobPosting(updatedJob);
    } catch (err) {
  ...
  try {
    setActionLoading(true);
     await jobPostingService.deleteJobPosting(jobPosting.id);
      ...
      <div className="bg-gray-50 py-8 md:py-12 min-h-screen">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            {/* Bouton de retour */}
            <div className="mb-6">
              <Link href="/job-postings" className="inline-flex items-center text-gray-600 hover:text-gray-800">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
                  <div className="px-6 py-4 sm:px-8 sm:py-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {jobPosting.status === 'published' && (
                        <Link
                          href={`/job-postings/${jobPosting.id}/applications`}
