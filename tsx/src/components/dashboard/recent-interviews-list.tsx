// frontend/components/dashboard/RecentInterviewsList.tsx
...
const RecentInterviewsList: React.FC<RecentInterviewsListProps> = ({ interviews }) => {
  // Si aucun entretien
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="mt-4 text-center">
        <a href="/interviews" className="text-primary-600 hover:text-primary-900 text-sm font-medium">
