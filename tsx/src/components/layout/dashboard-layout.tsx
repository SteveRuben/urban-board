...
import { NotificationProvider } from '@/provider/toast';
import ToastManager from '../notifications/toast-manager';
...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('NOTIFICATION_RECEIVED', handleNewNotification as EventListener);
    ...
    return () => {
      ...
      window.removeEventListener('NOTIFICATION_RECEIVED', handleNewNotification as EventListener);
    };
          ...
          <div className={`${sidebarOpen ? 'fixed' : 'hidden'} inset-0 flex z-40 md:hidden`}>
            ...
            <div className={`relative flex-1 flex flex-col max-w-xs w-full bg-white transition ease-in-out duration-300 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
              ...
              <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
                <>
                  <a href="/settings/profile" className="flex-shrink-0 group block">
          ...
          <div className="hidden md:flex md:flex-shrink-0">
            <div className="flex flex-col w-64">
              <div className="flex flex-col h-0 flex-1 bg-white border-r border-gray-200">
                ...
                <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
                  <>
                    <a href="/settings/profile" className="flex-shrink-0 w-full group block">
                      <div className="flex items-center">
                        <div>
                          <div className="relative h-9 w-9 rounded-full overflow-hidden bg-gray-100">
                            <Image
...
declare global {
  interface WindowEventMap {
    NOTIFICATION_RECEIVED: CustomEvent;
  }
}
