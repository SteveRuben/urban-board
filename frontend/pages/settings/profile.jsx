// frontend/pages/dashboard/profile.jsx
...
const ProfilePage = () => {
  ...
  const [twoFactorSetupState, setTwoFactorSetupState] = useState('idle'); // 'idle', 'setup', 'verify'
    ...
    const fetchUserData = async () => {
      try {
        ...
        if (profileData.integrations && profileData.integrations.length > 0) {
          ...
          profileData.integrations.forEach(integration => {
  ...
  const handleNotificationPreferenceChange = (category, type, checked) => {
