// frontend/pages/index.jsx  <Layout></Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              {user ? (
                <Link href="/interviews/new" className="bg-white text-primary-700 font-bold py-3 px-6 rounded-lg hover:bg-primary-50 transition duration-300">
                  Démarrer un entretien
                </Link>
              ) : (
                <Link href="/auth/register" className="bg-white text-primary-700 font-bold py-3 px-6 rounded-lg hover:bg-primary-50 transition duration-300">
