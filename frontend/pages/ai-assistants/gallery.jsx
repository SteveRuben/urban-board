// pages/ai-assistants/gallery.jsx
...
const AssistantTemplateCard = ({ template, onSelect }) => (
...
const AIAssistantGallery = () => {
  ...
  useEffect(() => {
    const fetchTemplates = async () => {
      try {
        ...
        setError('Erreur lors du chargement des modèles: ' + err.message);
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSelectTemplate = async (template) => {
    try {
      ...
      setError('Erreur lors de la sélection du modèle: ' + err.message);
    }
  };
