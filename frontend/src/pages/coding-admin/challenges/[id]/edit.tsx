...
export default function ChallengeFormPage( ) {
  ...
  const loadChallenge = async () => {
    try {
      ...
      const challenge = await CodingPlatformService.getChallenge(challengeId!);
      setFormData({
      ...
      // Charger aussi les infos de l'exercice
      const exerciseData = await CodingPlatformService.getExercise(challenge.exercise_id);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(null);
        ...
        await CodingPlatformService.updateChallenge(challengeId!, formData);
        router.push(`/coding-admin/challenges/${challengeId}`);
  ...
  const backUrl =  `/coding-admin/challenges/${challengeId}` 
