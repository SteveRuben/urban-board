// components/profile/NotificationPreferencesCard.tsx
...
interface NotificationCategoryProps {
  ...
  onNotificationPreferenceChange: (category: keyof NotificationPreferences, type: string, checked: boolean) => void;
